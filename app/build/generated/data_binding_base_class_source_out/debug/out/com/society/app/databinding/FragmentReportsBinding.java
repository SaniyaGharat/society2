...
public final class FragmentReportsBinding implements ViewBinding {
  ...
  private FragmentReportsBinding(@NonNull LinearLayout rootView, @NonNull RecyclerView rvReports) {
  ...
  public static FragmentReportsBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentReportsBinding((LinearLayout) rootView, rvReports);
    }
