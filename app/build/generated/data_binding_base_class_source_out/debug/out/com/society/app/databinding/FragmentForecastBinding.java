...
public final class FragmentForecastBinding implements ViewBinding {
  ...
  @NonNull
  public final TextView tvAverages;

  private FragmentForecastBinding(@NonNull LinearLayout rootView, @NonNull RecyclerView rvForecast,
      @NonNull TextView tvAverages) {
    this.rootView = rootView;
    this.rvForecast = rvForecast;
    this.tvAverages = tvAverages;
  }
  ...
  public static FragmentForecastBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.tvAverages;
      TextView tvAverages = ViewBindings.findChildViewById(rootView, id);
      if (tvAverages == null) {
        break missingId;
      }

      return new FragmentForecastBinding((LinearLayout) rootView, rvForecast, tvAverages);
    }
