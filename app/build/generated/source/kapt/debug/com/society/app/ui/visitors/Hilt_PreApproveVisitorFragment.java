 ...
 */
public abstract class Hilt_PreApproveVisitorFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_PreApproveVisitorFragment() {
    super();
  }

  Hilt_PreApproveVisitorFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((PreApproveVisitorFragment_GeneratedInjector) this.generatedComponent()).injectPreApproveVisitorFragment(UnsafeCasts.<PreApproveVisitorFragment>unsafeCast(this));
    }
  }
