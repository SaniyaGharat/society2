 ...
 */
public abstract class Hilt_ResidentProfileFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_ResidentProfileFragment() {
    super();
  }

  Hilt_ResidentProfileFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ResidentProfileFragment_GeneratedInjector) this.generatedComponent()).injectResidentProfileFragment(UnsafeCasts.<ResidentProfileFragment>unsafeCast(this));
    }
  }
