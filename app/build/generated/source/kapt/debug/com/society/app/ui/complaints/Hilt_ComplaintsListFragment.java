 ...
 */
public abstract class Hilt_ComplaintsListFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_ComplaintsListFragment() {
    super();
  }

  Hilt_ComplaintsListFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ComplaintsListFragment_GeneratedInjector) this.generatedComponent()).injectComplaintsListFragment(UnsafeCasts.<ComplaintsListFragment>unsafeCast(this));
    }
  }
