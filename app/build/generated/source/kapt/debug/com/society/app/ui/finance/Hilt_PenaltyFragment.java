 ...
 */
public abstract class Hilt_PenaltyFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_PenaltyFragment() {
    super();
  }

  Hilt_PenaltyFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((PenaltyFragment_GeneratedInjector) this.generatedComponent()).injectPenaltyFragment(UnsafeCasts.<PenaltyFragment>unsafeCast(this));
    }
  }
