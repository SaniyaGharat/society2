 ...
 */
public abstract class Hilt_AnnouncementDetailFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_AnnouncementDetailFragment() {
    super();
  }

  Hilt_AnnouncementDetailFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((AnnouncementDetailFragment_GeneratedInjector) this.generatedComponent()).injectAnnouncementDetailFragment(UnsafeCasts.<AnnouncementDetailFragment>unsafeCast(this));
    }
  }
