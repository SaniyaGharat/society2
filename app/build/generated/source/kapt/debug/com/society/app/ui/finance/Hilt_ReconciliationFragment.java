 ...
 */
public abstract class Hilt_ReconciliationFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_ReconciliationFragment() {
    super();
  }

  Hilt_ReconciliationFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ReconciliationFragment_GeneratedInjector) this.generatedComponent()).injectReconciliationFragment(UnsafeCasts.<ReconciliationFragment>unsafeCast(this));
    }
  }
