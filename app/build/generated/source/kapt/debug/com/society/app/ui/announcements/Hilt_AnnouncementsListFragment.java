 ...
 */
public abstract class Hilt_AnnouncementsListFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_AnnouncementsListFragment() {
    super();
  }

  Hilt_AnnouncementsListFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((AnnouncementsListFragment_GeneratedInjector) this.generatedComponent()).injectAnnouncementsListFragment(UnsafeCasts.<AnnouncementsListFragment>unsafeCast(this));
    }
  }
