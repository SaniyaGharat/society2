 ...
 */
public abstract class Hilt_AddComplaintFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_AddComplaintFragment() {
    super();
  }

  Hilt_AddComplaintFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((AddComplaintFragment_GeneratedInjector) this.generatedComponent()).injectAddComplaintFragment(UnsafeCasts.<AddComplaintFragment>unsafeCast(this));
    }
  }
