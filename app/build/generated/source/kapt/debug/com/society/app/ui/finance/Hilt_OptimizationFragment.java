 ...
 */
public abstract class Hilt_OptimizationFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_OptimizationFragment() {
    super();
  }

  Hilt_OptimizationFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((OptimizationFragment_GeneratedInjector) this.generatedComponent()).injectOptimizationFragment(UnsafeCasts.<OptimizationFragment>unsafeCast(this));
    }
  }
