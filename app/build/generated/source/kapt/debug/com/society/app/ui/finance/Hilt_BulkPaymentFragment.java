 ...
 */
public abstract class Hilt_BulkPaymentFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_BulkPaymentFragment() {
    super();
  }

  Hilt_BulkPaymentFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((BulkPaymentFragment_GeneratedInjector) this.generatedComponent()).injectBulkPaymentFragment(UnsafeCasts.<BulkPaymentFragment>unsafeCast(this));
    }
  }
