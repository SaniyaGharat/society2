 ...
 */
public abstract class Hilt_IntegrationFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_IntegrationFragment() {
    super();
  }

  Hilt_IntegrationFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((IntegrationFragment_GeneratedInjector) this.generatedComponent()).injectIntegrationFragment(UnsafeCasts.<IntegrationFragment>unsafeCast(this));
    }
  }
