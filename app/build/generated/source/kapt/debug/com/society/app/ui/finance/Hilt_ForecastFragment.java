 ...
 */
public abstract class Hilt_ForecastFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_ForecastFragment() {
    super();
  }

  Hilt_ForecastFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ForecastFragment_GeneratedInjector) this.generatedComponent()).injectForecastFragment(UnsafeCasts.<ForecastFragment>unsafeCast(this));
    }
  }
