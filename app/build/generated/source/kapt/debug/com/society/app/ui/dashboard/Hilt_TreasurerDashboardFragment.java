 ...
 */
public abstract class Hilt_TreasurerDashboardFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_TreasurerDashboardFragment() {
    super();
  }

  Hilt_TreasurerDashboardFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((TreasurerDashboardFragment_GeneratedInjector) this.generatedComponent()).injectTreasurerDashboardFragment(UnsafeCasts.<TreasurerDashboardFragment>unsafeCast(this));
    }
  }
