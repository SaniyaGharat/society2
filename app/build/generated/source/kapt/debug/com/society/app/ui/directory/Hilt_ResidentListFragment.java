 ...
 */
public abstract class Hilt_ResidentListFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_ResidentListFragment() {
    super();
  }

  Hilt_ResidentListFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ResidentListFragment_GeneratedInjector) this.generatedComponent()).injectResidentListFragment(UnsafeCasts.<ResidentListFragment>unsafeCast(this));
    }
  }
