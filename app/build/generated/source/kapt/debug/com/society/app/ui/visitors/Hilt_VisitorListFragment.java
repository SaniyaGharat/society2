 ...
 */
public abstract class Hilt_VisitorListFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_VisitorListFragment() {
    super();
  }

  Hilt_VisitorListFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((VisitorListFragment_GeneratedInjector) this.generatedComponent()).injectVisitorListFragment(UnsafeCasts.<VisitorListFragment>unsafeCast(this));
    }
  }
