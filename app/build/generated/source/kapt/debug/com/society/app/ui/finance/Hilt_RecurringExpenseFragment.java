 ...
 */
public abstract class Hilt_RecurringExpenseFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_RecurringExpenseFragment() {
    super();
  }

  Hilt_RecurringExpenseFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((RecurringExpenseFragment_GeneratedInjector) this.generatedComponent()).injectRecurringExpenseFragment(UnsafeCasts.<RecurringExpenseFragment>unsafeCast(this));
    }
  }
