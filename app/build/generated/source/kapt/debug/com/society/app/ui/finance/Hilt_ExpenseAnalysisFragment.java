 ...
 */
public abstract class Hilt_ExpenseAnalysisFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_ExpenseAnalysisFragment() {
    super();
  }

  Hilt_ExpenseAnalysisFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ExpenseAnalysisFragment_GeneratedInjector) this.generatedComponent()).injectExpenseAnalysisFragment(UnsafeCasts.<ExpenseAnalysisFragment>unsafeCast(this));
    }
  }
