 ...
 */
public abstract class Hilt_MonthlyHistoryFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_MonthlyHistoryFragment() {
    super();
  }

  Hilt_MonthlyHistoryFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((MonthlyHistoryFragment_GeneratedInjector) this.generatedComponent()).injectMonthlyHistoryFragment(UnsafeCasts.<MonthlyHistoryFragment>unsafeCast(this));
    }
  }
