 ...
 */
public abstract class Hilt_BalanceListFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_BalanceListFragment() {
    super();
  }

  Hilt_BalanceListFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((BalanceListFragment_GeneratedInjector) this.generatedComponent()).injectBalanceListFragment(UnsafeCasts.<BalanceListFragment>unsafeCast(this));
    }
  }
