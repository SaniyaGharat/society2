 ...
 */
public abstract class Hilt_RoleDemoFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_RoleDemoFragment() {
    super();
  }

  Hilt_RoleDemoFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((RoleDemoFragment_GeneratedInjector) this.generatedComponent()).injectRoleDemoFragment(UnsafeCasts.<RoleDemoFragment>unsafeCast(this));
    }
  }
